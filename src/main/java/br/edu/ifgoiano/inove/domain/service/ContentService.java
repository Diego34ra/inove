...
public interface ContentService {
    ...
    Content findById(Long courseId, Long sectionId, Long contentId);

    ContentOutputDTO findOneById(Long courseId, Long sectionId, Long contentId);
    ...
    void deleteById(Long courseId, Long sectionId, Long contentId);

    Long getContentAmountByCourseId(Long courseId);
}
